    ...
    <div className="h-screen w-full bg-[#09080e] text-white font-sans p-4 flex flex-col overflow-hidden box-border">
      ...
      <nav className="shrink-0 flex items-center justify-between px-6 py-2 bg-[#110f18] rounded-xl mb-3 border border-[#2a2638] shadow-lg">
        ...
        <div className="flex items-center bg-[#1a1723] rounded-xl p-1 border border-[#2a2638]">
          <button
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === 'dashboard' ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-md' : 'text-gray-400 hover:text-white'
              }`}
          ...
          <button
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === 'station' ? 'bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-md' : 'text-gray-400 hover:text-white'
              }`}
