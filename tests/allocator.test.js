...
describe('Allocator Priority Scoring', () => {
    it('prioritizes low battery heavily', () => {
        const vehicleLowBattery = { batteryLevel: 10, etaMinutes: 5 };
        const vehicleHighBattery = { batteryLevel: 80, etaMinutes: 5 };
    ...
    it('prioritizes low ETA', () => {
        const vehicleClose = { batteryLevel: 50, etaMinutes: 1 };
        const vehicleFar = { batteryLevel: 50, etaMinutes: 20 };
